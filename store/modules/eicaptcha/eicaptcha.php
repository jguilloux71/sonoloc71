...
class EiCaptcha extends Module
{
    ...
    private function displayCaptchaContactForm()
    {
        ...
        $js = '<script type="text/javascript">
            ...
            $(document).ready(function(){
               ...
               $("' . Configuration::get('CAPTCHA_CONTACTF_INSERT_SELECTOR') . '").before("<div id=\"captcha-box\" style=\"margin-left: 183px;\"></div>");
    ...
    protected function _debugModuleInstall()
    {
        ...
        $modulesHooks = array('displayHeader', 'displayCustomerAccountForm', 'contactFormAccess', 'actionBeforeSubmitAccount');
